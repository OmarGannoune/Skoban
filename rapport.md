...
- Extension à des grilles plus grandes (15×15, 20×20)
- Solveur interactif avec interface graphique
- Comparaison avec d'autres algorithmes (IDA*, RBFS)
- Génération automatique de niveaux

## 7. Bibliographie

- **Algorithme A*** : Hart, P. E., Nilsson, N. J., & Raphael, B. (1968)
- **Sokoban** : Hiroyuki Imabayashi (1982)
- **Pattern Databases** : Culberson & Schaeffer (1998)
- **Deadlock Detection** : Junghanns & Schaeffer (2001)

---

**Auteur** : Solution développée pour le projet Sokoban  
**Date** : Novembre 2025  
**Langage** : Java 8+  
**Complexité spatiale** : O(b^d) où b = facteur de branchement, d = profondeur  
**Complexité temporelle** : O(b^d) dans le pire cas